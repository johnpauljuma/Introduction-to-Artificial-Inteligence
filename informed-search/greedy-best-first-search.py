...
class environment(object):
    ...
    state = "1" #str(input("enter your start point: "))
    goal = "9" #str(input("enter your end point: "))
...
class agent(environment):
    ...
    def __init__(self, environment):
        print("gbfs heuristic path", agent.gbfs(environment.my_graph,environment.state, environment.goal))
        print("astar heuristic and cost path",agent.astar(environment.my_graph,environment.state,environment.goal))
envt = environment
agent1 = agent(envt)